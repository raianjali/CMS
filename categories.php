...
if (isset($_POST["Submit"])) {
  ...
  elseif (strlen($category)>99) {
    ...
    $Query="INSERT INTO category(dateT,name,creatorname) VALUES('$DateTime','$category','$Admin')";
    $Execute=mysqli_query($Connection,$Query);
    if($Execute){
      $_SESSION["SuccessMessage"] = "Successfully Added Category.";
      Redirect_to("categories.php");
    }
    else {
          ...
          <div id="aa">
            <nav class="navbar navbar-dark">
              ...
              <ul id="Side_Menu" class="nav nav-pills flex-column">
                ...
                <li class="mt-3 aa nav-item"><a  href="categories.php" class="nav-link active navbar-brand font-weight-bold"><span class="fa fa-tag" aria-hidden="true"></span>&nbsp;&nbsp;Categories</a></li>
